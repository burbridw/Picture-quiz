...
const fruitandvegBtn = document.getElementById("fruitandveg")
...
feelingsBtn.addEventListener("click",() => beginSelection(selectObj["feelings"]))
weatherBtn.addEventListener("click",() => beginSelection(selectObj["weather"]))
colorsBtn.addEventListener("click",() => beginSelection(selectObj["colors"]))
sportsBtn.addEventListener("click",() => beginSelection(selectObj["sports"]))
shapesBtn.addEventListener("click",() => beginSelection(selectObj["shapes"]))
foodsBtn.addEventListener("click",() => beginSelection(selectObj["foods"]))
dessertsBtn.addEventListener("click",() => beginSelection(selectObj["desserts"]))
drinksBtn.addEventListener("click",() => beginSelection(selectObj["drinks"]))
fruitandvegBtn.addEventListener("click",() => beginSelection(selectObj["fruitandveg"]))
ingredientsBtn.addEventListener("click",() => beginSelection(selectObj["ingredients"]))
mealsBtn.addEventListener("click",() => beginSelection(selectObj["meals"]))
tastesBtn.addEventListener("click",() => beginSelection(selectObj["tastes"]))
animalsBtn.addEventListener("click",() => beginSelection(selectObj["animals"]))
seaanimalsBtn.addEventListener("click",() => beginSelection(selectObj["seaanimals"]))
bugsBtn.addEventListener("click",() => beginSelection(selectObj["bugs"]))
natureBtn.addEventListener("click",() => beginSelection(selectObj["nature"]))
monthsBtn.addEventListener("click",() => beginSelection(selectObj["months"]))
seasonsBtn.addEventListener("click",() => beginSelection(selectObj["seasons"]))
timesofdayBtn.addEventListener("click",() => beginSelection(selectObj["timesofday"]))
daysBtn.addEventListener("click",() => beginSelection(selectObj["days"]))
countriesBtn.addEventListener("click",() => beginSelection(selectObj["countries"]))
familyBtn.addEventListener("click",() => beginSelection(selectObj["family"]))
peopleBtn.addEventListener("click",() => beginSelection(selectObj["people"]))
personalitiesBtn.addEventListener("click",() => beginSelection(selectObj["personalities"]))
actions1Btn.addEventListener("click",() => beginSelection(selectObj["actions1"]))
pastactionsBtn.addEventListener("click",() => beginSelection(selectObj["pastactions"]))
actions2Btn.addEventListener("click",() => beginSelection(selectObj["actions2"]))
dailyactivitiesBtn.addEventListener("click",() => beginSelection(selectObj["dailyactivities"]))
frequencyBtn.addEventListener("click",() => beginSelection(selectObj["frequency"]))
bodyBtn.addEventListener("click",() => beginSelection(selectObj["body"]))
clothesBtn.addEventListener("click",() => beginSelection(selectObj["clothes"]))
buildingsBtn.addEventListener("click",() => beginSelection(selectObj["buildings"]))
directionsBtn.addEventListener("click",() => beginSelection(selectObj["directions"]))
locationsBtn.addEventListener("click",() => beginSelection(selectObj["locations"]))
vehiclesBtn.addEventListener("click",() => beginSelection(selectObj["vehicles"]))
schoolBtn.addEventListener("click",() => beginSelection(selectObj["school"]))
subjectsBtn.addEventListener("click",() => beginSelection(selectObj["subjects"]))
instrumentsBtn.addEventListener("click",() => beginSelection(selectObj["instruments"]))
stationaryBtn.addEventListener("click",() => beginSelection(selectObj["stationary"]))
commonitemsBtn.addEventListener("click",() => beginSelection(selectObj["commonitems"]))
activitiesBtn.addEventListener("click",() => beginSelection(selectObj["activities"]))
schooleventsBtn.addEventListener("click",() => beginSelection(selectObj["schoolevents"]))
yearlyeventsBtn.addEventListener("click",() => beginSelection(selectObj["yearlyevents"]))
conditionsBtn.addEventListener("click",() => beginSelection(selectObj["conditions"]))
